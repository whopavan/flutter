...
class AnimationController extends Animation<double>
  ...
  TickerFuture repeat(
    ...
    return _startSimulation(_RepeatingSimulation(
        _value, min, max, reverse, period!, _directionSetter, times));
  }
  ...
  void _tick(Duration elapsed) {
    ...
    print('damn damn time $elapsedInSeconds');
...
class _RepeatingSimulation extends Simulation {
  _RepeatingSimulation(double initialValue, this.min, this.max, this.reverse,
      Duration period, this.directionSetter, this.times)
      : _periodInSeconds =
        ...
        _runTime = (times == null)
            ? null
            : (period.inMicroseconds / Duration.microsecondsPerSecond) * times {
  ...
  double x(double timeInSeconds) {
    ...
    if (reverse && _isPlayingReverse) {
      ...
      final double animateValue = ui.lerpDouble(max, min, t)!;
      return animateValue;
    }

    directionSetter(_AnimationDirection.forward);
    final double animateValue = ui.lerpDouble(min, max, t)!;
    return animateValue;
  }
  ...
  bool isDone(double timeInSeconds) {
    // print('$timeInSeconds');
    return _runTime == null ? false : timeInSeconds == _runTime!;
  }
}
